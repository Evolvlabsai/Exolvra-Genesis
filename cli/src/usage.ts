...
export const HELP_TOPICS: readonly HelpTopic[] = [
  {
    ...
    body: [
      ...
      '',
      'GITHUB_TOKEN: the credential the issue commands authenticate to GitHub with —',
      '`work` and `queue`. When it is unset, `gh auth token` is asked instead, and a',
      ...
      'it outright rather than adding to it. Naming no repository at all is an error',
      'and never means every repository the token can see.',
      '',
      'EXOLVRA_GENESIS_RUNNER_LOGIN: the GitHub account `work` posts as, for a token',
